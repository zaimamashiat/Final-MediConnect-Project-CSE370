...
<link rel="stylesheet" href="Home-Doctor.css" media="screen">
    ...
    <meta property="og:title" content="Home Doctor">
    <meta property="og:type" content="website">
  <meta data-intl-tel-input-cdn-path="intlTelInput/"></head>
  <body data-path-to-root="./" data-include-products="false" class="u-body u-overlap u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-a692"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Appointment.php" style="padding: 10px 20px;">Appointment</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Home-Doctor.php" style="padding: 10px 20px;">Home Doctor</a>
</li></ul>
          </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Appointment.php">Appointment</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Home-Doctor.php">Home Doctor</a>
</li></ul>
              </div>
            </div>
          ...
          <div class="u-layout-row">
            <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-26 u-layout-cell-1">
              <div class="u-container-layout u-valign-bottom u-container-layout-1">
                ...
                <h5 class="u-text u-text-1">Your Health Is Your Priority</h5>
                ...
                <h1 class="u-text u-text-2">MediConnect </h1>
                <quillbot-extension-highlights style="display: initial; visibility: initial; opacity: initial; clip-path: initial; position: absolute; float: left; top: 0px; left: 0px; z-index: 1 !important; pointer-events: none;"></quillbot-extension-highlights>
                <p class="u-custom-font u-font-georgia u-text u-text-3">Linking Health , Empowering Lives<span style="font-style: italic;">
                    <span style="font-style: normal;"></span>
                  </span>
                </p>
                <quillbot-extension-highlights style="display: initial; visibility: initial; opacity: initial; clip-path: initial; position: relative; float: left; top: 0px; left: 0px; z-index: 1 !important; pointer-events: none;"></quillbot-extension-highlights>
                <a href="view_app.php" class="u-btn u-btn-round u-button-style u-custom-font u-heading-font u-radius u-text-body-alt-color u-btn-1"> Check Appointment<span style="font-size: 1.25rem;"></span>
                </a>
                <quillbot-extension-highlights style="display: initial; visibility: initial; opacity: initial; clip-path: initial; position: relative; float: left; top: 0px; left: 0px; z-index: 1 !important; pointer-events: none;"></quillbot-extension-highlights>
                <a href="#" id="giveFeedbackBtn" class="u-border-2 u-border-hover-palette-1-base u-border-palette-1-base u-btn u-btn-round u-button-style u-hover-palette-1-base u-palette-1-base u-radius u-text-hover-white u-btn-2">Give Feedback</a>

                <div id="feedbackForm" style="display: none;">
                    <form action="submit_feedback.php" method="post">
                        
                        <input type="text" name="doctor_username" placeholder="Doctor's username" required>
                        <input type="text" name="patient_username" placeholder="Patient's Username" required>
                        <textarea name="feedback" placeholder="Feedback" rows="4" required></textarea>
                        <textarea name="test" placeholder="Tests Required" rows="4" required></textarea>
                        <textarea name="medicines" placeholder="Medicines Required" rows="4" required></textarea>

                        <button type="submit" class="u-btn u-btn-round u-button-style u-hover-palette-1-base u-palette-1-base u-radius u-text-hover-white">Submit Feedback</button>
                    </form>
                </div>
                ...
                <quillbot-extension-highlights style="display: initial; visibility: initial; opacity: initial; clip-path: initial; position: relative; float: left; top: 0px; left: 0px; z-index: 1 !important; pointer-events: none;"></quillbot-extension-highlights>
                <a href="my_account.php" class="u-btn u-btn-round u-button-style u-radius u-btn-3">My Account </a>
              </div>
            </div>
            <div class="u-container-style u-layout-cell u-right-cell u-size-34 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <img class="u-expanded-width u-image u-image-1" src="images/sd-min.jpg">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-container-style u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-group u-palette-1-base u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-7">
            <quillbot-extension-highlights style="display: initial; visibility: initial; opacity: initial; clip-path: initial; position: absolute; float: left; top: 0px; left: 0px; z-index: 1 !important; pointer-events: none;"></quillbot-extension-highlights>
            <h6 class="u-custom-font u-font-playfair-display u-text u-text-default u-text-13">Check Your</h6>
            <h2 class="u-custom-font u-font-playfair-display u-text u-text-14">Weekly Timetable</h2>
            <quillbot-extension-highlights style="display: initial; visibility: initial; opacity: initial; clip-path: initial; position: absolute; float: left; top: 0px; left: 0px; z-index: 1 !important; pointer-events: none;"></quillbot-extension-highlights>
            <p class="u-text u-text-15">You can see all the Appointment, arrange your schedule, and give feedback to the patients.</p>
            <quillbot-extension-highlights style="display: initial; visibility: initial; opacity: initial; clip-path: initial; position: absolute; float: left; top: 0px; left: 0px; z-index: 1 !important; pointer-events: none;"></quillbot-extension-highlights>
            <a href="#" class="u-btn u-btn-round u-button-style u-custom-font u-heading-font u-radius-30 u-text-palette-1-base u-white u-btn-1">Check </a>
          </div>
        </div>
      </div>
    </section>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-d430"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <script>
    document.getElementById("giveFeedbackBtn").addEventListener("click", function(event) {
